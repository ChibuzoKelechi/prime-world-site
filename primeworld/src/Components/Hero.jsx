        ...
        <article className="hero relative overflow-clip" id="top">
         <div className="banner relative">
            ...
            <img src={gif} alt="animated gif" className="absolute h-60 top-[20px] left-[50%]"/>
                <div className="herotext text-white text-center grid place-items-center">
                   <motion.div>     
                    ...
                    <p className="text-xs tracking-wide">As a global investment firm, we foster diverse perspectives and embrace innovation to help our clients navigate the uncertainty of capital markets</p>
                      <Button 
                        text='get started'
